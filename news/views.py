...
def ArticoloDetailView(request,pk):
    ...
    return render(request, "articolo_details.html", context)

def GiornalistaDetailView(request,pk):
    gionalista=get_object_or_404(Giornalista,pk=pk)
    context={"giornalista":giornalista}
    return render(request, "giornalista_details.html", context)
